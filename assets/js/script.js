...
// window.onload = getMelumatlariGetir
...
// DOM butun web site demekdir, content icindekiler (shekiller, yazilar ve s)
...
async function getproducts () {
    ...
    try{
        ...
        for (let i=0; i<mehsullar.length; i++) {
            ...
            class="w-full max-w-sm bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
...
// JSON - backend-den front end-e melumatlar getirir, unsuyyet dilidir
// JSON.stringify() vs JSON.parse() chatgpt-de arashdirmaq oyrenmek